...
![System Architecture](images/llm-code-reviewer%20(3).jpg)
---
...
* Provides comprehensive feedback using a fine-tuned OpenAI AI model, considering:
    ...
    * Maintainability
* Generates a comprehensive and clear report addressing issues in Markdown format, allowing for easy access to feedback without having to leaving your editor.
## 🚀Real Life Demo
https://github.com/user-attachments/assets/dfdd6145-1fa4-4380-a8b4-49049491a0ea
